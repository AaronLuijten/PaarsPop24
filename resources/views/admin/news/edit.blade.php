    ...
    <div class="flex flex-col items-center m-3">
        ...
        <div class="bg-purple-500 p-3 rounded-md">
            <form action="" method="POST" class="flex flex-col text-green-400 font-bold" enctype="multipart/form-data">
                ...
                <input type="submit" value="wijzigingen opslaan" id="submit" class="mt-2 w-fit p-1 text-green-400 border border-solid border-black bg-purple-500 rounded-md  hover:bg-white hover:text-green-500 hover:font-bold hover:scale-105 transition duration-300 m-2">
            </form>
        </div>
